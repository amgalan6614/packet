...
public:
    ...
    void setupUi(QMainWindow *PCAP)
    {
        ...
        textEdit->setGeometry(QRect(220, 0, 1101, 141));
        QFont font2;
        font2.setPointSize(12);
        textEdit->setFont(font2);
        lineEdit_4 = new QLineEdit(centralwidget);
        lineEdit_4->setObjectName(QStringLiteral("lineEdit_4"));
        lineEdit_4->setGeometry(QRect(110, 360, 91, 61));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(0, 360, 111, 61));
        QFont font3;
        font3.setPointSize(16);
        pushButton_2->setFont(font3);
        tableWidget = new QTableWidget(centralwidget);
        tableWidget->setObjectName(QStringLiteral("tableWidget"));
        tableWidget->setGeometry(QRect(220, 140, 1101, 521));
...
#ifndef QT_NO_TOOLTIP
        pushButton_2->setToolTip(QApplication::translate("PCAP", "<html><head/><body><p><br/></p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        pushButton_2->setText(QApplication::translate("PCAP", "Find", Q_NULLPTR));
    } // retranslateUi
